    ...
    public class MemoryDataGenerator
    {
        ...
        public MemoryDataSource Generate(int studentCount)
        {
            ...
            dataSource.Cities.AddRange(
                new[]
                {
                    new City {CityId = 1, CityName = "서울"},
                    new City {CityId = 2, CityName = "인천"},
                    new City {CityId = 3, CityName = "대전"},
                    new City {CityId = 4, CityName = "부산"},
                    new City {CityId = 5, CityName = "광주"},
                    new City {CityId = 6, CityName = "수원"},
                    new City {CityId = 7, CityName = "대구"},
                    new City {CityId = 8, CityName = "세종"},
                    new City {CityId = 9, CityName = "울산"},
                    new City {CityId = 10, CityName = "뉴욕"},
                    new City {CityId = 11, CityName = "보스턴"},
                    new City {CityId = 12, CityName = "시카고"},
                    new City {CityId = 13, CityName = "LA"},
                    new City {CityId = 14, CityName = "피닉스"},
                    new City {CityId = 15, CityName = "휴스턴"}
                });
            ...
            for (int i = 0; i < studentCount; i++)
            {
                ...
                var student = new Student
                {
                    ...
                    EmailAddress =
                        ...
                        personNames[surnameIndex].Surname.ToLower() + "@signalr.me",
